  ...
  return (
    <a
      ...
      style={{
        ...
        padding: size === 'large' ? '18px 36px' : '14px 28px',
        borderRadius: '2px',
        textDecoration: 'none',
  ...
  return (
    <>
      ...
      >
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-6 lg:px-16 py-28 lg:py-40">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <div className={`cta-reveal ${inView ? 'in' : ''} mb-12`} style={{ transitionDelay: '0.45s' }}>
              <p style={{ fontSize: '15px', color: 'rgba(255,255,255,0.45)', fontWeight: 300, lineHeight: 1.9, maxWidth: '440px', margin: '0 auto' }}>
                Contactez-nous directement sur WhatsApp pour une réponse rapide et un service entièrement personnalisé.
              </p>
            </div>

            {/* CTA */}
            <div className={`cta-reveal ${inView ? 'in' : ''} flex flex-col sm:flex-row items-center justify-center gap-6`} style={{ transitionDelay: '0.55s' }}>
            ...
            <div className={`cta-reveal ${inView ? 'in' : ''} mt-14 flex items-center justify-center gap-8 flex-wrap`} style={{ transitionDelay: '0.7s' }}>
              {[
                ...
                <div key={i} style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                  ...
                  <span style={{ fontSize: '12px', color: 'rgba(255,255,255,0.35)', fontWeight: 300, letterSpacing: '0.03em' }}>
                    {label}
                  </span>
                </div>
              ))}
