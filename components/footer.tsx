...
const experienceItems = ["Livraison a domicile", "Transferts aeroport", "Location business", "Evenements & mariage"]
  ...
  return (
    <footer className="relative overflow-hidden border-t border-white/10 bg-[#050505]">
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(circle at 12% 18%, rgba(212,175,55,0.12), transparent 34%), radial-gradient(circle at 88% 12%, rgba(255,255,255,0.07), transparent 24%), radial-gradient(circle at 50% 100%, rgba(212,175,55,0.08), transparent 40%)",
        }}
      />
