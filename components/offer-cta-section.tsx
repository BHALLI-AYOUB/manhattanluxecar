...
export default function OfferCTASection() {
  ...
  return (
    <>
      ...
      <section ref={ref} className="relative overflow-hidden bg-[#050505] py-20 md:py-28">
        <div
        ...
        <div className="relative z-10 mx-auto max-w-7xl px-6 lg:px-16">
          <div className={`offer-shell offer-reveal relative overflow-hidden rounded-[34px] px-6 py-8 sm:px-8 sm:py-10 lg:px-10 lg:py-12 ${inView ? "in" : ""}`}>
            ...
            <div className="relative grid items-center gap-8 lg:grid-cols-[1.1fr_0.9fr]">
              <div className="space-y-6">
                <div
                  className={`offer-reveal inline-flex items-center gap-3 rounded-full border border-black/12 bg-black/8 px-4 py-2 text-[11px] font-medium uppercase tracking-[0.28em] text-black/70 ${inView ? "in" : ""}`}
                ...
                <div className={`offer-reveal space-y-4 ${inView ? "in" : ""}`} style={{ transitionDelay: "0.16s" }}>
                  <h2 className="max-w-3xl font-serif text-4xl font-semibold leading-[0.98] text-black md:text-5xl lg:text-6xl">
                ...
                <div className={`offer-reveal flex flex-wrap gap-3 ${inView ? "in" : ""}`} style={{ transitionDelay: "0.24s" }}>
                  <a
                    href="#fleet"
                    className="inline-flex items-center justify-center gap-2 rounded-full bg-black px-7 py-4 text-sm font-semibold uppercase tracking-[0.14em] text-white transition-all duration-300 hover:-translate-y-0.5 hover:bg-black/90 hover:shadow-[0_16px_35px_rgba(0,0,0,0.22)]"
                  >
                  ...
                  <WhatsAppButton
                    ...
                    className="rounded-full border border-black/14 bg-white/25 px-7 py-4 text-sm font-semibold uppercase tracking-[0.14em] text-black hover:bg-white/35 hover:text-black hover:shadow-[0_14px_30px_rgba(255,255,255,0.14)]"
                  />
                </div>
                ...
                <div className={`offer-reveal grid gap-3 sm:grid-cols-2 xl:grid-cols-4 ${inView ? "in" : ""}`} style={{ transitionDelay: "0.32s" }}>
                  {serviceSignals.map((item) => (
                    <div
                      key={item}
                      className="rounded-2xl border border-black/10 bg-black/6 px-4 py-3 text-[11px] font-medium uppercase tracking-[0.2em] text-black/72"
                    >
                      {item}
                    </div>
                  ))}
              ...
              <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-1">
                ...
                >
                  ...
                  <div className="font-serif text-5xl leading-none text-[#D4AF37] sm:text-6xl">24/7</div>
